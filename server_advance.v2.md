...
```
Creamos un array de objetos en JSON con los campos **id, name, lat, long e imagen**
```json
[
  {
    "name": "El Torno",
    "lat": "40.13574566123074",
    "long": "-5.944696325637326",
    "id": 1,
    "imagen": "/assets/167102432321020190707_140329.jpg"
  },
  {
    "name": "Cabezabellosa",
    "lat": "40.13761747082106",
    "long": "-6.37457881446697",
    "imagen": "/assets/16747526284341200px-PanorÃ¡mica_de_Cabezabellosa",
    "id": 2
  }
]
...
### 2. Creamos el archivo **appAdvanced.v2.js** (servirá la web) con la siguiente información
...
```js
node appAdvanced.v2.js
```

### 5. Pruebas con Postman

#### GET
> !![img_2.png](img_2.png)[get_appAdvanced.jpg](./assets/images/appAdvanced/get_appAdvanced.jpg)
#### GET por ID
> ![img_5.png](img_5.png)
#### POST
> ![img_6.png](img_6.png)
